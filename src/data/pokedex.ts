/** Display name for each of the 151 Kanto species, keyed by Pokédex number */
export const KANTO_NAMES: Record<number, string> = {
...
/** Sprite URL for a given Pokédex number (uses PokeAPI CDN — same source as our fetches) */
